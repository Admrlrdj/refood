<div x-show="isDeleteModalOpen" x-cloak style="display: none;"
    ...
    <div @click.away="isDeleteModalOpen = false"
        ...
        <h3 class="text-xl font-semibold text-gray-800 dark:text-white/90 mb-2">Hapus Yayasan?</h3>
        <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Menghapus data <span
                class="font-bold text-gray-800 dark:text-white" x-text="deleteForm.foundation_name"></span> akan
            menghapus
            akunnya secara permanen.</p>
        ...
        <div class="flex justify-center gap-3">
            ...
            <form :action="'/admin/receivers/' + deleteForm.id" method="POST" class="w-full m-0">
                @csrf @method('DELETE')
                <button type="submit"
