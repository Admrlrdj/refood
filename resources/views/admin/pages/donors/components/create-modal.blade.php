<div x-show="isModalOpen" x-cloak style="display: none;"
    ...
    <div @click.away="isModalOpen = false"
        ...
        <div class="flex items-center justify-between mb-5">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white/90">Tambah Donatur Baru</h3>
        ...
        <form action="{{ route('admin.donors.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="restaurant_name" required
                    class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:text-white"
                    placeholder="Contoh: Warteg Pak Budi">
            </div>

            <div class="pt-2 border-t border-gray-100 dark:border-gray-800">
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Titik Lokasi Restoran
                    (OpenStreetMap)</label>
                <div class="flex gap-2 mb-3">
                    <input id="mapSearchInput" type="text"
                        ...
                        placeholder="Cari alamat restoran... (Contoh: Monas)">
