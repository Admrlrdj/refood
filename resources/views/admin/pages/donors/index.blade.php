...
@section('content')
    @php
        $mappedDonors = $donors->map(function ($d) {
            return [
                'id' => (string) $d->_id,
                'name' => $d->name,
                'email' => $d->email,
    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-title-md2 font-bold text-black dark:text-white">Data Donatur</h2>
            <nav>
                <ol class="flex flex-wrap items-center gap-1.5">
                    ...
                    <li class="flex items-center gap-1.5"><span class="text-gray-500 dark:text-gray-400">/</span><span
                            class="text-sm font-medium text-gray-800 dark:text-white/90">Donors</span></li>
                </ol>
            </nav>
        </div>
        ...
        @if ($errors->any())
            <div x-data="{ showAlert: true }" x-show="showAlert" x-transition
                ...
                <div class="w-full mt-0.5">
                    <ul class="list-disc list-inside text-sm text-error-500">
        ...
        <div x-data="donorTable()">

            @include('admin.pages.donors.components.create-modal')
            @include('admin.pages.donors.components.edit-modal')
            @include('admin.pages.donors.components.delete-modal')

            <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="flex flex-col gap-4 px-5 mb-4 md:flex-row md:items-center md:justify-between sm:px-6">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Daftar Donatur</h3>
                    </div>
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                        <div class="relative">
                            ...
                            <input type="text" x-model="search" placeholder="Cari resto/email..."
                    ...
                    <div class="max-w-full px-5 overflow-x-auto">
                        <table class="min-w-full">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <template x-for="d in paginatedItems" :key="d.id">
                                        ...
                                        <td class="px-4 py-4 text-sm font-medium text-right whitespace-nowrap">
                                            <div class="flex items-center justify-end space-x-3">
                                                ...
                                                <div class="flex space-x-2">
                                                    <template x-if="!d.is_verified">
                                                        <form :action="'/admin/donors/' + d.id + '/verify'" method="POST"
                                                            class="inline">
                                                    ...
                                                    <template x-if="d.is_verified">
                                                        <form :action="'/admin/donors/' + d.id + '/reject'" method="POST"
                                                            class="inline">
                                                ...
                                                <button type="button" @click="openEditModal(d)" title="Edit Data"
                                                ...
                                                <button type="button" @click="openDeleteModal(d)" title="Hapus Data"
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('donorTable', () => ({
                ...
                openEditModal(donor) {
                    ...
                    this.editForm.latitude = donor.latitude || -6.200000;
                    this.editForm.longitude = donor.longitude || 106.816666;
                ...
                get filteredItems() {
                    ...
                    return this.allItems.filter(item =>
                        item.restaurant_name.toLowerCase().includes(this.search
                            .toLowerCase()) ||
