<div x-show="isEditModalOpen" x-cloak style="display: none;"
    ...
    <div @click.away="isEditModalOpen = false"
        ...
        <div class="flex items-center justify-between mb-5">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white/90">Edit Admin: <span x-text="editForm.name"
        ...
        <form :action="'/admin/users/' + editForm.id" method="POST" class="space-y-4">
            ...
            <div>
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Password Baru</label>
