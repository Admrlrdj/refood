<div x-show="isEditModalOpen" x-cloak style="display: none;"
    ...
    <div @click.away="isEditModalOpen = false"
        ...
        <div class="flex items-center justify-between mb-5">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white/90">Edit Relawan: <span x-text="editForm.name"
            ...
            <div>
                ...
                <div class="relative z-20 bg-transparent">
                    <select name="vehicle_type" x-model="editForm.vehicle_type" required
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 text-gray-800 dark:text-white/90">
