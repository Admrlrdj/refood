...
class MenuHelper
{
    public static function getMainNavItems()
    {
        return [
            [
                'icon' => 'dashboard',
                'name' => 'Dashboard',
                'path' => '/admin/dashboard', // Pastikan path-nya sesuai route kamu
            ],
            [
                'icon' => 'foods', // Icon baru
                'name' => 'Foods',
                'path' => '/admin/foods',
            ],
            [
                'icon' => 'deliveries', // Icon baru
                'name' => 'Deliveries',
            ...
            [
                ...
                'subItems' => [
                    ...
                    ['name' => 'Admins', 'path' => '/admin/users'],
                ],
            ],
            [
                'icon' => 'charts', // Menggunakan icon chart bawaan
                'name' => 'Reports',
                'path' => '/admin/reports',
            ],
        ];
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            // Icon Reports/Charts (Asli bawaan, cocok buat Reports)
        ...
        // Jika icon tidak ditemukan, tampilkan default star/sparkle
        return $icons[$iconName] ?? '<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>';
    }
}
